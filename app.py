...
st.markdown("""
    ...
    .main-title { text-align: center !important; margin-bottom: 20px !important; font-size: 1.5rem !important; font-weight: bold; }
...
if w_mm > 0 and h_mm > 0 and pitch > 0 and logo_img and bg_files:
    ...
    if preview:
        ...
        st.markdown(f'<div style="text-align:center;margin-bottom:20px;"><img src="data:image/jpeg;base64,{img_str}" style="max-width:100%;max-height:300px;border-radius:4px;border:1px solid #ddd;"></div>', unsafe_allow_html=True)
